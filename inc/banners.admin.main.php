...
class MainController
{
	...
	public function indexAction()
	{
		...
		$sortFields = array(
			...
			array('ba_begin', $L['ba_begin']),
			array('ba_expire', $L['ba_expire']),
		);
...
//            $item['ba_id'] = cot_import('rid', 'P', 'INT');
		...
		$tpl->assign(array(
			...
			'FORM_BEGIN' => cot_selectbox_date(cot_date2stamp($banner->ba_begin, 'auto'), 'long', 'rbegin'),
			'FORM_PUBLISH_DOWN' => cot_selectbox_date(cot_date2stamp($banner->ba_expire, 'auto'), 'long', 'rexpire'),
