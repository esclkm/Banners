...
<div class="block">
    ...
    <table class="cells">
        ...
        <tr>
            ...
            <td class="{LIST_ROW_ODDEVEN}">
                <a href="{LIST_ROW_URL}" class="ajax button list icon">{PHP.L.Edit}</a>
    ...
    <!-- ENDIF -->
        <a href="{PHP|cot_url('admin', 'm=other&p=banners&n=queries&a=edit')}" class="button confirm">{PHP.L.Add}</a>
    </div>
</div>
